...
import { inquiryFormSchema, type InquiryFormData, getErrorMessage } from '@/lib/schemas/form-schemas'
...
export function InquiryForm() {
  ...
  const { inquiryForm, setInquiryForm, isFormSubmitted, setIsFormSubmitted } = useInquiryForm()
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="name"
                {...form.register('name')}
                placeholder={language === 'zh' ? '请输入您的姓名' : 'Enter your full name'}
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={language === 'zh' ? '请输入您的国籍' : 'Enter your nationality'}
              />
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => form.setValue('serviceInterest', value as any)}
            >
              <SelectTrigger>
                <SelectValue placeholder={language === 'zh' ? '选择服务类型' : 'Select service type'} />
              </SelectTrigger>
              <SelectContent>
            ...
            {form.formState.errors.serviceInterest && (
              <p className="text-sm text-destructive">
                {getErrorMessage(form.formState.errors.serviceInterest, language)}
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => form.setValue('preferredContact', value as any)}
            >
              <SelectTrigger>
                <SelectValue placeholder={language === 'zh' ? '选择联系方式' : 'Select contact method'} />
              </SelectTrigger>
              <SelectContent>
            ...
            {form.formState.errors.preferredContact && (
              <p className="text-sm text-destructive">
                {getErrorMessage(form.formState.errors.preferredContact, language)}
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={language === 'zh' ? '例如：5000-10000' : 'e.g., 5000-10000'}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder={language === 'zh' ? '请告诉我们您的具体需求...' : 'Tell us about your specific needs...'}
              rows={4}
            />
          ...
          <div className="space-y-4">
            ...
            {form.formState.errors.agreeToPrivacy && (
              <p className="text-sm text-destructive">
                {getErrorMessage(form.formState.errors.agreeToPrivacy, language)}
              </p>
            )}
          </div>
