    ...
    <Card className={cn('w-full max-w-2xl mx-auto', className)}>
      <CardHeader className="text-center">
        <CardTitle className="text-2xl">
          <BilingualText en="Get Your Free Consultation" zh="获取免费咨询" />
        </CardTitle>
        <CardDescription>
          <BilingualText
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                <SelectTrigger
                  className={cn(errors.serviceInterest && 'border-red-500')}
                >
          ...
          <Button
            ...
            className="w-full bg-primary hover:bg-primary/90 text-white hover:scale-105 transition-all duration-300"
            size="lg"
          >
            {isSubmitting ? (
              <>
            ...
            <div className="text-center pt-4 border-t border-[#e5e7eb]">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center text-sm">
                <span className="flex items-center gap-1">
                  ...
                  <BilingualText
                    en="Call: +82-10-2981-6653"
                    zh="电话：+82-10-2981-6653"
                  />
                </span>
                ...
                <span className="flex items-center gap-1">
                  ...
                  <BilingualText
                    en="Email: seoulcareconcierge@gmail.com"
                    zh="邮箱：seoulcareconcierge@gmail.com"
                  />
                </span>
              </div>
            </div>
